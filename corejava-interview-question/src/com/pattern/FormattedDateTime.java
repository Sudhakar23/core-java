...
//http://javatronoak.blogspot.in/2012/08/?
/*
...
class FormattedTimeDate {
	...
	public static void main(String[] args) {
		...
		{
			// Misc. usage
			// Note that the specifiers refer to the same argument in the format
			// string.
			...
			out.printf(
					"The world will end on %1$tA, %1$te. %1$tB %1$tY at %1$tH:%1$tM:%1$tS.%n",
					myCalender);
